...
#ifndef URLPARAMFLOAT_H_
#define URLPARAMFLOAT_H_
 ...
 * @see UrlParam 
 */
class UrlParamFloat : public UrlParam
{
public:
	/**
	 ...
	 */
    UrlParamFloat( float defVal = FLT_MIN );
    UrlParamFloat( int protocol, float defVal = FLT_MIN );
