...
#ifndef __WDB2TS_WDB_FORECAST_TAG_H__
#define __WDB2TS_WDB_FORECAST_TAG_H__
...
class WdbForecastTag : public XmlBase 
{
	std::string indent;
...
public:
	...
	WdbForecastTag( GMLContext &context ) : gmlContext( &context ){}
	
	virtual ~WdbForecastTag(){
		if( out )
			(*out) << indent << "</mox:forecast>\n";
	}
