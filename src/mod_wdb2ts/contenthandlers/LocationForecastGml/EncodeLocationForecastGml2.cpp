...
const std::string EncodeLocationForecastGml2::metatemplate("<!--@@META@@-->");

EncodeLocationForecastGml2::
BreakTimes::
...
EncodeLocationForecastGml2::
EncodeLocationForecastGml2( RequestIterator &reqit_,
...
EncodeLocationForecastGml2::BreakTimeList::const_iterator
EncodeLocationForecastGml2::
