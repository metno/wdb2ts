/*
    ...
    MA  02110-1301, USA
*/
#ifndef __ENCODE_LOCATIONFORECAST3_H__
#define __ENCODE_LOCATIONFORECAST3_H__
 ...
 */
class EncodeLocationForecast3 : public Encode
{
	struct BreakTimes {
		std::string provider;
	...
	void updatePrecipAggregates( LocationElem &location,
...
public:
	 ...
	 */
	EncodeLocationForecast3( LocationPointDataPtr locationPointData,
	                         const ProjectionHelper *projectionHelper,
	                         float longitude,
	                         float latitude,
	                         int   altitude,
	...
	/// Destructor
	virtual ~EncodeLocationForecast3();
