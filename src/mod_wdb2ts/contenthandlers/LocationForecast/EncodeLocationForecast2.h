/*
    ...
    MA  02110-1301, USA
*/
#ifndef __ENCODE_LOCATIONFORECAST2_H__
#define __ENCODE_LOCATIONFORECAST2_H__
 ...
 */
class EncodeLocationForecast2 : public Encode
{
	struct BreakTimes {
		std::string provider;
...
public:
	 ...
	 */
	EncodeLocationForecast2( LocationPointDataPtr locationPointData,
			                const ProjectionHelper *projectionHelper,
			                float longitude,
			                float latitude,
			                int   altitude,
	...
	/// Destructor
	virtual ~EncodeLocationForecast2();
