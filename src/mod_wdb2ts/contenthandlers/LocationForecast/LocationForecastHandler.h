/*
    ...
    MA  02110-1301, USA
*/
#ifndef __LOCATION_FORECAST_HANDLER_H__
#define __LOCATION_FORECAST_HANDLER_H__
...
public:
	 ...
	 * @param	minor 
	 */
	LocationForecastHandler( int major, int minor, const std::string &note="" );
	/** Destructor */
	~LocationForecastHandler();
