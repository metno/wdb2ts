...
namespace dnmi{
  namespace file{
	...
	{ 
       ...
       */
      bool       isBlock()const  { return S_ISBLK(mode());}
       ...
       */
      bool isSetUID()const { return mode()&S_ISUID;}
       ...
       */
      bool isSetGID()const { return mode()&S_ISGID;}
